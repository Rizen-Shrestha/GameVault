...
<body>
    ...
    <nav class="sidebar-nav">
        ...
        <a href="${pageContext.request.contextPath}/users" class="nav-item">
        ...
        <div class="top-sections">
            ...
            <section class="card manage-users">
                <div class="card-header">
                    ...
                    <span class="badge-active">102 ACTIVE</span>
                </div>
                <div class="user-avatars">
                    <div class="user-card">
                        <div class="user-avatar-img"></div>
                        <span class="user-label">SOME GUY</span>
                    </div>
                    <div class="user-card">
                        <div class="user-avatar-img"></div>
                        <span class="user-label">NEXT GUY</span>
                    </div>
                    <div class="user-card online">
                        <div class="user-avatar-img"></div>
                        <span class="user-label">ONLINE GUY</span>
